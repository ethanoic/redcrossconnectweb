  ...
  (function($) {
    $.easyPieChart = function(el, options) {
      ...
      addScaleLine = function(i) {
        ...
        _this.ctx.fillRect(_this.options.size / 2 - offset - 10, 0, -_this.options.size * 0.05 + offset, 1);
...
$(document).ready(function () {
  // var key = "0AutKxTrK4NLmdDJQbTVIeXBSRTBsbjhmUWNucGtJSnc"
  // var url="https://spreadsheets.google.com/feeds/list/"+ key +"/1/public/values?alt=json-in-script&callback=?";
  // $.getJSON(url , function(data) {
  //   var entry = data.feed.entry[0];
  //   $("#bloodtypea").data("percent", entry.gsx$bloodtypea.$t);
  //   $("#bloodtypeb").data("percent", entry.gsx$bloodtypeb.$t);
  //   $("#bloodtypeab").data("percent", entry.gsx$bloodtypeab.$t);
  //   $("#bloodtypeo").data("percent", entry.gsx$bloodtypeo.$t);
  ...
  $('.btn-plus-donate').click(function(){
    $('html, body').animate({scrollTop:$('#nav-locate').position().top}, 'slow');
    return false;
  });
...
var infoWindow;
var current_marker;
var bank1 = new google.maps.LatLng(1.2809352, 103.8375668);
var bank2 = new google.maps.LatLng(1.4359454, 103.7861284);
var bank3 = new google.maps.LatLng(1.3001956, 103.8477121);
var mapProp = {
  center:bank1,
  zoom:15,
  panControl:true,
...
function setMarker(bank, map, contentInfo){
  ...
  google.maps.event.addListener(marker, 'click', function() {
    ...
    calcRoute(start, bank);
  });
}

function rad(x) {return x*Math.PI/180;}

function find_nearest_bank(position){
  ...
  current_marker = markers[closest];
  calcRoute(position,markers[closest].position);
}
...
function initialize()
{
  ...
  setMarker(bank1, map, contentInfo1);
  setMarker(bank2, map, contentInfo2);
  setMarker(bank3, map, contentInfo3);
}
  ...
  var Validator = function ( options ) {
    ...
    */
    this.messages = {
      ...
      , rangelength:    "It should be between %s and %s characters long."
